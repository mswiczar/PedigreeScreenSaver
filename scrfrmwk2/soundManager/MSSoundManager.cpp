...
int process_Line(int posicion)
{
	...
	wsprintfW(salida,L"cant_01_20_RED : %d \n",elresult[posicion].cant_01_20_RED );
	OutputDebugStringW(salida);

	ZeroMemory(salida,sizeof(salida));
	wsprintfW(salida,L"cant_21_30_RED : %d \n",elresult[posicion].cant_21_30_RED );
	OutputDebugStringW(salida);

	ZeroMemory(salida,sizeof(salida));
	wsprintfW(salida,L"cant_31_50_RED : %d \n",elresult[posicion].cant_31_50_RED );
	OutputDebugStringW(salida);

	ZeroMemory(salida,sizeof(salida));
	wsprintfW(salida,L"cant_51_90_RED : %d \n",elresult[posicion].cant_51_90_RED);
	OutputDebugStringW(salida);
	...
	if(  (elresult[posicion].cant_51_90_RED > 1) )
	{
		elresult[posicion].ruido=1;
	}
...
int analyze (int posicion_insertar)
{
	...
	for (int i=5; i>0 ; i--)
	{
		...
		ZeroMemory(salida,sizeof(salida));
		wsprintfW(salida,L"sum_ruido %d \n" , sum_ruido);
		OutputDebugStringW(salida);
		ZeroMemory(salida,sizeof(salida));
		wsprintfW(salida,L"sum_vocal %d \n" , sum_vocal);
		OutputDebugStringW(salida);
		ZeroMemory(salida,sizeof(salida));
		wsprintfW(salida,L"sum_silbido %d \n" , sum_silbido);
		OutputDebugStringW(salida);
	...
	if (sum_silbido >130)
	{
		...
		ZeroMemory(salida,sizeof(salida));	
		wsprintfW(salida,L"siiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII" , sum_silbido);
		OutputDebugStringW(salida);
		return 1;
	}
